...
import type { MessagesResponseWithSearchPageMessageListExpand } from '@/api'
import { appUserDefaultAvatar, fileUserAvatarConfig } from '@/config'
import { pb } from '@/lib'
import { useI18nStore } from '@/stores'
import {
  useMessageContentProcess,
  useMessageContentWithTimeProcess,
  useMessageLinkProcess,
} from '@/composables'
import { useTimeAgo } from '@vueuse/core'

const props = defineProps<{
  messageItem: MessagesResponseWithSearchPageMessageListExpand
}>()
